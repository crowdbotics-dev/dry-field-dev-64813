"""
Django settings for dry_field_dev_64813 project.
...
ROOT_URLCONF = 'dry_field_dev_64813.urls'
...
WSGI_APPLICATION = 'dry_field_dev_64813.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_field_dev_64813 API",
    "DESCRIPTION": "API documentation for dry_field_dev_64813 App",
    "VERSION": "v1",
}
